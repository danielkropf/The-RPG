...
public class levelUpSkills : MonoBehaviour {
	...
	public GameObject fblvl;
	public GameObject expllvl;
	public GameObject heallvl;
	public GameObject drainlvl;
	public GameObject revengelvl;
	public GameObject doublelvl;
	...
	void Update() {
		...
		txt = fblvl.GetComponent<Text>();
		txt.text = "LVL -> " + fireballLvl;
		txt = expllvl.GetComponent<Text>();
		txt.text = "LVL -> " + explosionLvl;
		txt = heallvl.GetComponent<Text>();
		txt.text = "LVL -> " + healLvl;
		txt = drainlvl.GetComponent<Text>();
		txt.text = "LVL -> " + drainLvl;
		txt = revengelvl.GetComponent<Text>();
		txt.text = "LVL -> " + revengeLvl;
		txt = doublelvl.GetComponent<Text>();
		txt.text = "LVL -> " + doubleHitLvl;
